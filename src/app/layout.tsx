  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <GoogleAnalytics />
        {/* Harbor AI SEO */}
        <Script data-harbor-site="nd70pb9sd9fpewcxsyk028at0n8368ee" src="https://outgoing-oyster-428.convex.site/api/harbor-seo.js?siteId=nd70pb9sd9fpewcxsyk028at0n8368ee" strategy="afterInteractive" />
        {/* Google AdSense */}
