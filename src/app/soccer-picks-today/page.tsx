...
export const metadata: Metadata = {
  title: 'Free Soccer Picks Today - Expert Consensus Picks | DailyAI Betting',
  description: 'Get free soccer picks today from top cappers. Our AI analyzes expert consensus to find the best soccer bets. Updated daily with moneyline, spread, and total goals picks.',
  keywords: 'free soccer picks today, soccer betting picks, soccer consensus picks, soccer best bets, soccer expert picks, MLS picks, Champions League picks',
}

export default function SoccerPicksToday() {
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Free Soccer Picks Today</h1>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">🔥 Today&apos;s Soccer Consensus Picks</h2>
        <p className="mb-4">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">How Our Soccer Picks Work</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">Soccer Betting Resources</h2>
